...
class Usertype extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('usertypedsc', 'required'),
			array('usertypedsc', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idusertype, usertypedsc', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'users' => array(self::HAS_MANY, 'User', 'idusertype'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('usertypedsc',$this->usertypedsc,true);
