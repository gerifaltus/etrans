    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 hide" id="contentOrderOut">
                    <div class="table-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <strong>Orden de Salida</strong>
                            </div>
                            <div class="col-sm-6" id="titleTransfer">
                                <strong>De Transferencia: 134273 del 05 de Noviembre de 2014</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 tbl-transfer">
                            <table id="transfer_table" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>Item</th>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    &nbsp; &nbsp; &nbsp;
                                    <a class="btn btn-info" href="#" id="aplicaSalida">
...
<div id="newOrderOut-form" class="modal" tabindex="-1">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">Orden de Salida</h4>
            </div>

            <div class="modal-body">
                <div class="control-group">
                    <label class="control-label bolder blue">Seleccione opci&oacute;n</label>

                    <div class="radio">
                        <label>
                            <input name="newOutOrder" class="ace" type="radio" id="newOutOrder">
                            <span class="lbl"> Nueva Orden</span>
                        </label>
                    </div>
                    ...
                    <div class="radio">
                        <label>
                            ...
                            <span class="lbl"> De Transferencia</span>
                        </label>
                        <input class="input-sm" id="form-field-4" type="text">
                    </div>
                </div>
                <div class="modal-footer">
                    <!--<div class="col-md-offset-3 col-md-9">-->
                    <a href="#" class="btn" data-dismiss="modal">Close</a>
                    <a href="#" class="btn btn-primary" data-dismiss="modal" id="showContentOrderOut">Ir</a>
                    <!--</div>-->
                </div>
            </div>
        </div>
...
<div id="confirmOrderOut-form" class="modal" tabindex="-1">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="blue bigger">Confirmaci&oacute;n</h4>
            </div>

            <div class="modal-body">
                <div class="control-group">
                    <p>¿Desea aplicar la salida?</p>
                </div>
                <div class="modal-footer">
                    <!--<div class="col-md-offset-3 col-md-9">-->
                    <a href="#" class="btn" data-dismiss="modal">Close</a>
                    <a href="#" class="btn btn-primary" data-dismiss="modal" id="showPrintOrderOut">Ir</a>
                    <!--</div>-->
                </div>
            </div>
        </div>
...
<div id="showPrintOrderOut-form" class="modal" tabindex="-1">
    <div class="modal-dialog" style="width:400px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                <div class="control-group">
                    <p>Movimiento aplicado.</p>
                    <p>¿Desea imprimir el comprobante?</p>
                </div>
                <div class="modal-footer">
                    <!--<div class="col-md-offset-3 col-md-9">-->
                    <a href="#" class="btn" data-dismiss="modal">Close</a>
                    <a href="<?php echo Yii::app()->createUrl('request/printOrderTransfer');?>" class="btn btn-primary" id="showPrintOrderOut">Imprimir</a>
                    <!--</div>-->
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //muestra popup al momento de cargar la pagina para seleccionar nueva orden o desde transferencia
        $('#newOrderOut-form').modal('show');

        //muestra la ventana principal al momento de seleccionar nueva orden o por medio de numero de transferenciañ

        $('#showContentOrderOut').click(function () {
            //event.preventDefault();
            //event.stopPropagation();
            $('#contentOrderOut').removeClass('hide');

            if($('#newOutOrder').is(':checked'))
            {
                $('#titleTransfer').hide();
            }
        ...
        //procesa salida y muestra pdf
        $('#aplicaSalida').click(function () {
            $('#confirmOrderOut-form').modal('show');
        });

        $('#showPrintOrderOut').click(function () {
         $('#showPrintOrderOut-form').modal('show'); 
     });
...
/*
        $('#resumenTransferCodigo_table').DataTable({
            responsive: true,
            searching: false,
            paging: false,
            info: false,
