...
var tree_data_2 = {
	'zRecepcion' : {name: '<strong>Zona - Recepción</strong><br><span>20m x 50m  = 1000m2</span><br><span>TLC1.01.01</span>', type: 'folder', 'icon-class':' orange zRecepcion ', additionalParameters: { id: 'FF21' }},
	'zMaquila' : {name: '<strong>Zona - Maquila</strong><br><span>30m x 30m = 900m2</span><br><span>TLC1.01.02</span>', type: 'folder', 'icon-class':'orange zMaquila '},
	'zAlmacenamiento' : {name: '<strong>Zona - Almacenamiento</strong><br><span>80m x 90m = 7200m2</span><br><span>TLC1.01.03</span>', type: 'folder', 'icon-class':'blue zAlmacenamiento '}	,
}

tree_data_2['zRecepcion']['additionalParameters'] = {
	'children' : [
		{name: '<i class="'+ace_icon+' fa fa-music blue"></i> <strong>Área - Andenes</strong><br><span>TLC1.01.01.01 - TLC1.01.01.24</span>', type: 'item'}
	]
}

tree_data_2['zAlmacenamiento']['additionalParameters'] = {
	'children' : {
		'aAltaRotacion' : {name: '<strong>Área - Alta Rotación</strong><br><span>80m x 30m = 2400m2</span><br><span>TLC1.01.03.01</span>', type: 'folder', 'icon-class':' pink aARotacionSvg ' },
		'aMediaRotacion' : {name: '<strong>Área - Media Rotación</strong><br><span>80m x 30m = 2400m2</span><br><span>TLC1.01.03.02</span>', type: 'folder', 'icon-class':' pink aMRotacionSvg '},
		'aBajaRotacion' : {name: '<strong>Área - Baja Rotación</strong><br><span>80m x 30m = 2400m2</span><br><span>TLC1.01.03.03</span>', type: 'folder', 'icon-class':' gray aBRotacionSvg '}
	}
}

tree_data_2['zAlmacenamiento']['additionalParameters']['children']['aAltaRotacion']['additionalParameters'] = {
	'children' : [
		{name: '<i class="'+ace_icon+' rA fa fa-th green fa-lg"></i> <strong>Rack A </strong><br><span>A0101.1 - A2006.2</span><br><span>Single (240u)</span>', type: 'item'},
		{name: '<i class="'+ace_icon+' rB fa fa-th green fa-lg"></i> <strong>Rack B </strong><br><span>B0101.1 - B2006.2</span><br><span>Single (240u)</span>', type: 'item'},
		{name: '<i class="'+ace_icon+' rC fa fa-th green fa-lg"></i> <strong>Rack C </strong><br><span>C0101.1 - C2006.2</span><br><span>Single (240u)</span>', type: 'item'},
		{name: '<i class="'+ace_icon+' bD fa fa-cube green fa-lg	"></i> <strong>Bloque D </strong><br><span>D0101.1 - D0402.1</span><br><span>10m x 5m, 4x2 (8u)</span>', type: 'item'}
	]
}
